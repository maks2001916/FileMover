...
public class OpenLanguageResources {
    ...
    public void collectingLanguageNames() {
        ...
        for (int i = 0; i < directory.length; i++) {
            ...
            languageOpenPropertiesFile(getLanguageName(i));
    ...
    public void languageOpenPropertiesFile(String lang) {
    ...
    public void renameTitles(HomeWimdow homeWimdow,
                             int lang) {
        languageOpenPropertiesFile(getLanguageName(lang));
        ...
        homeWimdow.getSelectLanguage().setText(getProperties("languageSmall"));
